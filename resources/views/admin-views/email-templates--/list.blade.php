    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-baseline gap-2">
                ...
                {{\App\CPU\translate('Email Template')}}
            </h2>
        </div>
        <!-- End Page Title -->
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="d-flex gap-2 align-items-center">
                                    {{\App\CPU\translate('Email')}} {{\App\CPU\translate('Template')}} {{\App\CPU\translate('table')}}
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4">
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-merge input-group-custom">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control" placeholder="{{\App\CPU\translate('Search_by_Name_or_Mobile_No_or_Email')}}" aria-label="Search orders" value="{{ $search }}">
                                ...
                                <tr style="background: {{$contact->seen==0?'rgba(215,214,214,0.56)':'white'}}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <a title="{{\App\CPU\translate('View')}}" class="btn btn-outline-info btn-sm square-btn" href="{{route('admin.email-templates.view',$contact->id)}}">
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.email-templates.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
                            toastr.success('{{\App\CPU\translate('Email_Template_deleted_successfully')}}');
                            location.reload();
                        }
                    });
                }
