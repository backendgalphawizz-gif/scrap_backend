    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{\App\CPU\translate('Scheme')}} {{\App\CPU\translate('Setup')}}
            </h2>
        </div>
        <!-- End Page Title -->
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{ \App\CPU\translate('Scheme Title') }}</label>
                                        <input type="text" name="title" class="form-control" placeholder="{{\App\CPU\translate('enter_Scheme Title')}}" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{ \App\CPU\translate('Code') }}</label>
                                        <input type="text" name="code" class="form-control" placeholder="{{\App\CPU\translate('enter_Scheme_code')}}">
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-center gap-10">
                                            ...
                                            <div class="modal fade" id="exampleModal{{$category['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <form action="{{route('admin.scheme.update')}}" method="POST" >
                                                    ...
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="title-color" for="priority">{{\App\CPU\translate('scheme title')}}
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.scheme.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
                            toastr.success('{{\App\CPU\translate('Scheme_deleted_Successfully.')}}');
                            location.reload();
                        }
                    });
                }
