...
@section('title', \App\CPU\translate('scope'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10">
                ...
                {{\App\CPU\translate('scope')}} {{\App\CPU\translate('Setup')}}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.scheme.scope.store')}}" method="POST" >
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{ \App\CPU\translate('Select area') }}</label>
                                        <select name="area_id" class="form-control" id="area_id" required></select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="title-color" for="priority">{{ \App\CPU\translate('Scope Title') }}</label>
                                        <input type="text" name="title" class="form-control" placeholder="{{\App\CPU\translate('enter Scope Title')}}" required>
                                    </div>
                                </div>
                                <!-- <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex justify-content-center gap-10">
                                            ...
                                            <div class="modal fade" id="exampleModal{{$category['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <form action="{{route('admin.scheme.scope.update')}}" method="POST" >
                                                    <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Edit Scope</h5>
                                                    ...
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label class="title-color" for="priority">{{\App\CPU\translate('Scope title')}}
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.scheme.scope.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
...
<script>
   ...
   $(document).on('change', '#scheme_id', function () {
        ...
        if (schemeId) {
            $.ajax({
                url: "{{ url('admin/scheme/get-areas') }}/" + schemeId, 
                type: 'GET',
                dataType: 'json',
