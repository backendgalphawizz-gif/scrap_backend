...
@section('content')
    <div class="content container-fluid">
        <!-- Page Title -->
        <div class=" mb-3">
            <h2 class="h1 mb-0 d-flex gap-2 align-items-baseline backbtndiv">
                ...
                <form class="product-form" action="{{ route('admin.product.store') }}" method="POST"
                        ...
                        <div class="card-body">
                            @foreach (json_decode($language) as $lang)
                                ...
                                <!-- <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <div class="form-group d-none pt-4">
                            ...
                            <!-- <div class="row d-none">
                                <div class="col-lg-2">
                                    <div class="d-flex align-items-center gap-1 ">
                                        <label class="mb-0" for="">{{\App\CPU\translate('Free Delivery')}}</label>
                                        <input type="checkbox" name="free_delivery" value="1">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="d-flex align-items-center gap-1">
                                        <label class="mb-0" for="">{{\App\CPU\translate('Returnable / Cancellable')}}</label>
                                        <input type="checkbox" name="returnable" value="1">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="d-flex align-items-center gap-1">
                                        <label class="mb-0" for="">{{\App\CPU\translate('Warranty Policy')}}</label>
                                        <input type="checkbox" name="is_warranty_policy" value="1">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="d-flex align-items-center gap-1">
                                        <label class="mb-0" for="">{{\App\CPU\translate('Top Brand')}}</label>
                                        <input type="checkbox" name="top_brand" value="1">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="d-flex align-items-center gap-1">
                                        <label class="mb-0" for="">{{\App\CPU\translate('Alpha Verified')}}</label>
                            ...
                            <!-- <div class="row mt-4 d-none">
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name="made_in" value="" placeholder="Ex: India" class="form-control">
                                </div>
                                <div class="col-lg-3">
                                    <label for="">{{\App\CPU\translate('Warranty')}}</label>
                                    <input type="text" name="warranty" value="" placeholder="Ex: 1 Year" class="form-control">
                                </div>
                                <div class="col-lg-3">
                                    <label for="">{{\App\CPU\translate('Manufacturing Date')}}</label>
                                    <input type="date" name="manufacturing_date" value="" placeholder="Ex: 1 Year" class="form-control">
                                </div>
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-4 d-none" id="digital_product_type_show">
                                        ...
                                        <select name="digital_product_type" id="digital_product_type" class="js-example-responsive" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-responsive" name="category_id"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-responsive" name="sub_category_id"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-responsive" name="sub_sub_category_id" id="sub-sub-category-select"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="card mt-2 rest-part">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        ...
                                        <!-- <div class="col-md-3 d-none form-group physical_product_show" id="shipping_cost_multy">
                                            <div>
                                                <label
                            ...
                            <div class="card mt-2 mb-2 rest-part">
                                <div class="card-header " style="DISPLAY: flex; JUSTIFY-CONTENT: flex-start;">
                                    ...
                                    <label class="switcher ml-2">
                                        <input type="checkbox" class="switcher_input" id="bulk_switcher" value="{{ old('bulk_pricing') }}" name="bulk_pricing">
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
                            ...
                            <!-- <div class="card mt-2 mb-2 d-none rest-part">
                                <div class="card-header">
