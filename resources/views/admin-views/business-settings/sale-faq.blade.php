...
@section('title', \App\CPU\translate('Sale FAQ'))
        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">
                    <span></span>Sale Management &rsaquo; Sale FAQ
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Manage Sale FAQ</h5>
                    <button type="button" class="btn btn-sm btn-primary" id="addFaqBtn">
                        <i class="mdi mdi-plus"></i> Add FAQ
                    </button>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.business-settings.sale-faq-update') }}" method="POST" id="faqForm">
                        @csrf
                        <div id="faqList">
