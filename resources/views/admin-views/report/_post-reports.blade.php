            ...
            <div class="card">
                <div class="card-header border-0">
                    <div class="w-100 d-flex flex-wrap gap-3 align-items-center">
                        ...
                        <a class="btn btn-outline-primary ms-auto" href="{{ route('admin.post.reports.export', ['date_type' => $date_type, 'from' => ($from instanceof \Carbon\Carbon ? $from->format('Y-m-d') : $from), 'to' => ($to instanceof \Carbon\Carbon ? $to->format('Y-m-d') : $to)]) }}">
                    ...
                    <div class="premium-pagination-wrap">
                        <div class="premium-pagination-shell">
                            <div class="premium-pagination-inline">
                                {!! $posts->onEachSide(1)->links('vendor.pagination.premium') !!}
                            </div>
                        </div>
                    </div>
                @endif
