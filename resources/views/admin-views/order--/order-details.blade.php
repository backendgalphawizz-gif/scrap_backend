                        ...
                        <div class="d-flex flex-wrap gap-10 justify-content-between mb-4">
                            ...
                            <div class="text-sm-right">
                                <div class=" gap-10">
                                    ...
                                    <a class="btn btn--primary px-4 d-none" href="javascript:void(0)" onclick="swal.fire('Invoie Copy sent to customer successfully', '','sucecss')">
                                        <i class="tio-send mr-1"></i> {{\App\CPU\translate('Send')}} {{\App\CPU\translate('invoice')}}
                                    </a>
                    ...
                    <div class="card-body text-capitalize d-flex flex-column gap-4">
                        ...
                        <div class="">
                            ...
                            <select name="order_status" onchange="order_status(this.value)"
                                ...
                                <option value="pending" {{$order->order_status == 'pending'?'selected':''}} > {{\App\CPU\translate('Pending')}}</option>
                                <option value="confirmed" {{$order->order_status == 'confirmed'?'selected':''}} > {{\App\CPU\translate('Confirmed')}}</option>
                                ...
                                <option class="text-capitalize" value="out_for_delivery" {{$order->order_status == 'out_for_delivery'?'selected':''}} >{{\App\CPU\translate('out_for_delivery')}} </option>
                        ...
                        <ul class="list-unstyled list-unstyled-py-4">
                            ...
                            <li class="choose_delivery_man d-none">
                                ...
                                <input type="number" id="deliveryman_charge" onblur="amountDateUpdate(this, event)" value="{{ $order->deliveryman_charge }}" name="deliveryman_charge" class="form-control" placeholder="Ex: 20" value="0">
                            </li>
                            <li class="choose_delivery_man d-none">
                                <label class="font-weight-bold title-color fz-14">
                                    {{\App\CPU\translate('expected_delivery_date')}}
                                </label>
                                <input type="date" onblur="amountDateUpdate(this, event)" value="{{ $order->expected_delivery_date }}" name="expected_delivery_date" id="expected_delivery_date" class="form-control">
                            </li>
                            <li class="d-none mt-2" id="by_third_party_delivery_service_info">
                                <span>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if(data.customer_status==0)
                            {
                                ...
                                swal.fire('{{\App\CPU\translate('Account has been deleted, you can not change the status!')}} !!', '', 'warning').then(function() {
                                    location.reload();
                                });
                            ...
                            {
                                swal.fire('{{\App\CPU\translate('Status Change successfully')}} !!', '', 'success').then(function() {
                                    location.reload();
                                });
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.success == 0) {
                                    ...
                                    // location.reload();
                                    swal.fire('{{\App\CPU\translate('Order is already delivered, You can not change it')}} !!', '', 'success').then(function() {
                                        location.reload();
                                    });
                                } else {
                                    ...
                                    if(data.payment_status == 0){
                                        ...
                                        // location.reload();
                                        swal.fire('{{\App\CPU\translate('Before delivered you need to make payment status paid!')}} !!', '', 'warning').then(function() {
                                            location.reload();
                                        });
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.success == 0) {
                                    swal.fire('{{\App\CPU\translate('Order is already delivered, You can not change it')}} !!', '', 'info').then(function() {
                                        location.reload();
                                    });
                                } else {
                                    if(data.payment_status == 0){
                                        ...
                                        // toastr.warning('{{\App\CPU\translate('Before delivered you need to make payment status paid!')}}!').then(function() {
                                        //     location.reload();
                                        // });
                                    }else if(data.customer_status==0)
                                    {
                                        ...
                                        // toastr.warning('{{\App\CPU\translate('Account has been deleted, you can not change the status!')}}!').then(function() {
                                        //     location.reload();
                                        // });
                                        // location.reload();
                                    }else{
                                        ...
                                        // toastr.success('{{\App\CPU\translate('Status Change successfully')}}!').then(function() {
                                        //     location.reload();
                                        // });
                                        // location.reload();
                                    }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == true) {
                        ...
                        swal.fire('{{\App\CPU\translate('Delivery man successfully assigned/changed')}} !!', '', 'success').then(function() {
                            location.reload();
                        });
                        ...
                        swal.fire('{{\App\CPU\translate('Deliveryman man can not assign/change in that status')}} !!', '', 'error').then(function() {
                            location.reload();
                        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == true) {
                        ...
                        swal.fire('{{\App\CPU\translate('Deliveryman charge add successfully')}} !!', '', 'success').then(function() {
                            // location.reload();
                        });
                        ...
                        swal.fire('{{\App\CPU\translate('Failed to add deliveryman charge')}} !!', '', 'error').then(function() {
                            // location.reload();
                        });
