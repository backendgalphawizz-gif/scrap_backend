...
@section('title', \App\CPU\translate('Customer Bulk Import'))
        ...
        <div class="row" style="text-align: {{ Session::get('direction') === "rtl" ? 'right' : 'left' }};">
            <div class="col-12">
                <div class="card card-body">
                    ...
                    <p>4. {{ \App\CPU\translate('After uploading customers you may need to edit their profiles if necessary.') }}</p>
                    <p>5. {{ \App\CPU\translate('Please ensure the data is accurate and matches required formats.') }}</p>
                </div>
            </div>

            <div class="col-md-12 mt-2">
                <form class="customer-form" action="{{ route('admin.customer.bulk-import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card rest-part">
                        <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
                            ...
                            <a href="{{ asset('public/assets/customer_bulk_format.xlsx') }}" download="" class="btn-link text-capitalize fz-16 font-weight-medium">{{ \App\CPU\translate('download_here') }}</a>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        <div class="upload-file">
                                            <input type="file" name="customers_file" accept=".xlsx, .xls" class="upload-file__input">
