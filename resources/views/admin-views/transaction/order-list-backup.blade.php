                        ...
                        <!-- <div class="col-sm-6 col-md-3">
                            <div class="">
                                <select class="form-control __form-control" name="status">
                                    ...
                                    <option class="text-capitalize"
                                            value="disburse" {{ $status == 'disburse'? 'selected' : '' }} >{{\App\CPU\translate('complete')}} </option>
                                    <option class="text-capitalize"
                ...
                <div class="card h-100 bg-white payment-statistics-shadow">
                    ...
                    <div class="card-body px-0 pt-0">
                        ...
                        <div class="apex-legends">
                            ...
                            <div class="before-bg-004188">
                                <span>{{\App\CPU\translate('Approved_payments')}} ({{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payment_data['cash_payment'])) }})</span>
                            </div>
                            <div class="before-bg-CDE6F5">
                                <span>{{\App\CPU\translate('Pending_payments')}} ({{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payment_data['offline_payment'])) }})</span>
                            </div>
                        </div>
                    </div>
                </div>
