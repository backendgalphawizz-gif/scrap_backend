...
@section('title', \App\CPU\translate('Transactions'))
        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                <div class="left-content-card">
                    ...
                    <div class="info">
                        <h4 class="subtitle">{{ $order_data['applications'] }}</h4>
                        <h6 class="subtext">{{\App\CPU\translate('Total Applications')}}</h6>
                    </div>
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        <h4 class="subtitle">{{ $order_data['users'] }}</h4>
                        <h6 class="subtext">{{\App\CPU\translate('Total CAB')}}</h6>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body px-0 pt-0">
                        <div class="position-relative pie-chart">
                            ...
                            <div class="total--orders">
                                <h3>${{ round($payment_data['total_payment'],2)}}</h3>
                        ...
                        <div class="apex-legends">
                            ...
                            <div class="before-bg-004188">
                                <span>{{\App\CPU\translate('Approved_payments')}} $({{$payment_data['cash_payment'] }})</span>
                            </div>
                            <div class="before-bg-CDE6F5">
                                <span>{{\App\CPU\translate('Pending_payments')}} $({{$payment_data['offline_payment']}})</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{\App\CPU\translate('Application No.')}}</th>
                        <th>{{\App\CPU\translate('Application Type')}}</th>
                        <th>{{\App\CPU\translate('Cab Details')}}</th>
                        <th>{{\App\CPU\translate('Application Fee Details')}}</th>
                        <th>{{\App\CPU\translate('Document Fee Details')}}</th>
                        <th>{{\App\CPU\translate('Assessment Fee Details')}}</th>
                        <th>{{\App\CPU\translate('Technical Assessment Fee Details')}}</th>
                        <th class="text-center">{{\App\CPU\translate('Action')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($fees as $key=>$transaction)
                        <tr>
                            <td>{{$fees->firstItem()+$key}}</td>
                            <td>
                                <a class="title-color" href="{{route('admin.application.view-detail',[$transaction['application_id']])}}">{{$transaction->application->reference_number ?? '-'}}</a>
                            </td>
                            <td>
                                {{$transaction->application->application_type ?? '-'}}
                            </td>
                           
                            <td>
                                {{$transaction->application->company?->name ?? '-'}}
                            </td>
                            <td>
                                ...
                                <p>
                                    ...
                                    @elseif($transaction->application_fee_status == 1)
                                    <span class="badge badge-soft-success">
                                        Approved
                                    </span>
                                    @elseif($transaction->application_fee_status == 2)
                            ...
                            <td>
                                ...
                                <p>
                                    ...
                                    @elseif($transaction->document_fee_status == 1)
                                    <span class="badge badge-soft-success">
                                        Approved
                                    </span>
                                    @elseif($transaction->document_fee_status == 2)
                                    <span class="badge badge-soft-danger">
                                        Reject
                                    </span>
                                    @else
                            ...
                            <td>
                                ...
                                <p>
                                    ...
                                    @elseif($transaction->assessment_fee_status == 1)
                                    <span class="badge badge-soft-success">
                                        Approved
                                    </span>
                                    @elseif($transaction->assessment_fee_status == 2)
                                    <span class="badge badge-soft-danger">
                                        Reject
                                    </span>
                                    @else
                            ...
                            <td>
                                ...
                                <p>
                                    ...
                                    @elseif($transaction->technical_assessment_fee_status == 1)
                                    <span class="badge badge-soft-success">
                                        Approved
                                    </span>
                                    @elseif($transaction->technical_assessment_fee_status == 2)
                                    <span class="badge badge-soft-danger">
                                        Reject
                                    </span>
                                    @else
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a href="{{route('admin.application.view-detail',[$transaction['application_id']])}}" class="btn btn-outline-success square-btn btn-sm">
    ...
    <script>
        var options = {
            ...
            labels: [
                ...
                '{{\App\CPU\translate('cash_payment')}} (${{ ($payment_data['cash_payment']) }})',
                ...
                '{{\App\CPU\translate('offline_payments')}} (${{ ($payment_data['offline_payment']) }})',
            ],
            dataLabels: {
                enabled: false,
                style: {
