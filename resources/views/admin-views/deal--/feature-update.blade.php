...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex gap-2 align-items-center">
            ...
            {{\App\CPU\translate('update_Special_Offer')}}
        </h2>
    </div>
    <!-- End Page Title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.deal.update',[$deal['id']])}}" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" method="post" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-lg-4 mt-3">
                                    <div class="form-group">
                                        <div class="text-center">
                                            <img class="border radius-10 max-w-655px w-100" id="viewer"
