...
@section('title', \App\CPU\translate('Create Voucher'))
...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">
            ...
            {{ \App\CPU\translate('Create Voucher') }}
        </h3>
    </div>
            ...
            <form action="{{ route('admin.voucher.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="voucher_brands_id" class="form-control" required>
                            ...
                            @foreach($voucherBrands as $brand)
                                <option value="{{ $brand->id }}" {{ old('voucher_brands_id') == $brand->id ? 'selected' : '' }}>{{ $brand->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0" name="coin_price" class="form-control" value="{{ old('coin_price') }}" required>
                        @error('coin_price')<small class="text-danger">{{ $message }}</small>@enderror
                    </div>
                    <div class="col-md-4">
                        <label>Fiat Value</label>
                        <input type="number" step="0.01" min="0" name="fiat_value" class="form-control" value="{{ old('fiat_value') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" min="0" name="validity_days" class="form-control" value="{{ old('validity_days', 0) }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" min="1" name="max_uses_per_user" class="form-control" value="{{ old('max_uses_per_user', 1) }}" required>
