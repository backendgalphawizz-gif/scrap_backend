                    ...
                    <div class="card-body">
                        <form id="submit-create-role" action="{{route('admin.custom-role.update',[$role['id']])}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group d-flex gap-2">
                                        <input type="checkbox" name="modules[]" value="feedback_management"  {{in_array('feedback_management',(array)json_decode($role['module_access']))?'checked':''}} class="module-permission" id="feedback_management">
                                        <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group d-flex gap-2">
                                        <input type="checkbox" name="modules[]" value="voucher_management"  {{in_array('voucher_management',(array)json_decode($role['module_access']))?'checked':''}} class="module-permission" id="voucher_management">
                                        <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group d-flex gap-2">
                                        <input type="checkbox" name="modules[]" value="notification_management"  {{in_array('notification_management',(array)json_decode($role['module_access']))?'checked':''}} class="module-permission" id="notification_management">
                                        <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group d-flex gap-2">
                                        <input type="checkbox" name="modules[]" value="activity_logs"  {{in_array('activity_logs',(array)json_decode($role['module_access']))?'checked':''}} class="module-permission" id="activity_logs">
                                        <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group d-flex gap-2">
                                        <input type="checkbox" name="modules[]" value="support_management"  {{in_array('support_management',(array)json_decode($role['module_access']))?'checked':''}} class="module-permission" id="support_management">
                                        <label class="title-color mb-0" style="{{Session::get('direction') === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
