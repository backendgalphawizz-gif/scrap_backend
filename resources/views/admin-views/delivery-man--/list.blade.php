                    ...
                    <div class="table-responsive datatable-custom">
                        <table class="table table-hover table-borderless table-thead-bordered table-align-middle card-table {{ Session::get('direction') === 'rtl' ? 'text-right' : 'text-left' }}">
                            ...
                            <tr>
                                ...
                                <th class="d-none">{{\App\CPU\translate('Rating')}}</th>
                            ...
                            @forelse($delivery_men as $key=>$dm)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column gap-1">
                                            <div><a class="title-color hover-c1" href="javascript:void(0)">{{ $dm->seller->f_name ?? 'Self' }}<strong> {{$dm->seller->shop->name ?? ''}}</strong></a></div>
                                            <a class="title-color hover-c1" href="tel:+{{$dm->seller->phone??''}}">{{ $dm->seller->phone ?? '' }}</a>
                                        </div>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.delivery-man.order-history-log', ['id' => $dm['id']]) }}" class="badge fz-14 badge-soft--primary">
