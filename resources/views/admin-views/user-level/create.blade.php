            ...
            <form action="{{ route('admin.user-level.store') }}" method="POST">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" id="range_min" name="range_min" min="0" required>
                    </div>
                    <div class="col">
                        <label for="range_max" class="form-label">Level Range Max</label>
                        <input type="number" class="form-control" id="range_max" name="range_max" min="0" required>
                    </div>
                </div>
                <div class="mb-3">
                    <label for="max_participations_per_day" class="form-label">Max Participations Per Day</label>
                    <input type="number" class="form-control" id="max_participations_per_day" name="max_participations_per_day" min="1" required>
                </div>
