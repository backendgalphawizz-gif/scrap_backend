                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="d-flex gap-2 align-items-center">
                                    {{\App\CPU\translate('SMS')}} {{\App\CPU\translate('Template')}} {{\App\CPU\translate('table')}}
                                ...
                                <tr style="background: {{$contact->seen==0?'rgba(215,214,214,0.56)':'white'}}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <a title="{{\App\CPU\translate('View')}}" class="btn btn-outline-info btn-sm square-btn" href="{{route('admin.sms-templates.view',$contact->id)}}">
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.sms-templates.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
