<?php return array (
  ...
  'Uncheck for normal invoice' => 'uncheck for normal invoice on completion',
  'Download GST Invoice' => 'Download GST Invoice',
  'Download Invoice' => 'Download Invoice',
  'Invoice is only available for completed campaigns.' => 'Invoice is only available for completed campaigns.',
  'GST invoice is only available for completed campaigns.' => 'Invoice is only available for completed campaigns.',
  'GST invoice was not requested for this campaign.' => 'GST invoice was not requested for this campaign.',
  ...
  'Profession status updated successfully' => 'Profession status updated successfully',
  'Failed to update profession status' => 'Failed to update profession status',
  'Profession deleted successfully' => 'Profession deleted successfully',
  'Failed to delete profession' => 'Failed to delete profession',
  ...
  'Voucher Brand List' => 'Voucher Brand List',
  'Voucher Brands' => 'Voucher Brands',
  'Add Voucher Brand' => 'Add Voucher Brand',
  'Create Voucher Brand' => 'Create Voucher Brand',
  'Edit Voucher Brand' => 'Edit Voucher Brand',
  ...
  'Min' => 'Min',
  'Max' => 'Max',
  'Guideline line' => 'Guideline line',
  'Enter a guideline line' => 'Enter a guideline line',
  'add' => 'Add',
  'Each line will be saved as a comma separated value' => 'Each line will be saved as a comma separated value',
  'Guideline list' => 'Guideline list',
  'No guideline lines added yet' => 'No guideline lines added yet',
  'edit' => 'Edit',
  'Update guideline line' => 'Update guideline line',
  'Guideline line cannot be empty' => 'Guideline line cannot be empty',
  'Please enter a guideline line' => 'Please enter a guideline line',
  ...
  'bank_rejection_reason' => 'Bank rejection reason',
  'pan_rejection_reason' => 'Pan rejection reason',
  ...
  'Sale Referral Code' => 'Sale Referral Code',
  'Platforms' => 'Platforms',
  'Media' => 'Media',
  'Thumbnail' => 'Thumbnail',
  ...
  'Left Days' => 'Left Days',
  'Budget  Rewards & Performance' => 'Budget  Rewards & Performance',
  'Final Reward For User' => 'Final Reward For User',
  'Feedback Coin' => 'Feedback Coin',
  'Used Posts' => 'Used Posts',
  'Campaign User Budget' => 'Campaign User Budget',
  'Campaign Budget With GST' => 'Campaign Budget With GST',
  ...
  'Campaign deleted successfully' => 'Campaign deleted successfully',
  'Are you sure  ' => 'Are you sure  ',
  'User level deleted successfully' => 'User level deleted successfully',
  'Failed to delete user level' => 'Failed to delete user level',
  'User Activity Logs' => 'User Activity Logs',
  'Failed to update status' => 'Failed to update status',
  'Failed to delete brand category' => 'Failed to delete brand category',
  'Brand category deleted successfully' => 'Brand category deleted successfully',
  'Activate or deactivate' => 'Activate or deactivate',
  'All Transactions' => 'All Transactions',
  'Transactions' => 'Transactions',
  'All Types' => 'All Types',
  'User Wallet' => 'User Wallet',
  'Sale Wallet' => 'Sale Wallet',
  'Commission Ledger' => 'Commission Ledger',
  'Campaign Participation' => 'Campaign Participation',
  'Search reference  party  details' => 'Search reference  party  details',
  'From date' => 'From date',
  'To date' => 'To date',
  'Reset' => 'Reset',
  'Coin credits  debits & withdrawals' => 'Coin credits  debits & withdrawals',
  'Sale user wallet movements' => 'Sale user wallet movements',
  'Sale commission entries' => 'Sale commission entries',
  'User campaign participations' => 'User campaign participations',
  'Reference' => 'Reference',
  'Party' => 'Party',
  'Details' => 'Details',
  'View in section' => 'View in section',
  'Do you want to approve this withdrawal request ' => 'Do you want to approve this withdrawal request ',
  'Yes  approve it!' => 'Yes  approve it!',
  'Reject withdrawal ' => 'Reject withdrawal ',
  'Coins will be refunded to the user wallet.' => 'Coins will be refunded to the user wallet.',
  'Rejection reason (optional)' => 'Rejection reason (optional)',
  'Yes  reject it!' => 'Yes  reject it!',
  'Failed to delete voucher brand' => 'Failed to delete voucher brand',
  'Voucher brand deleted successfully' => 'Voucher brand deleted successfully',
  'Failed to delete voucher' => 'Failed to delete voucher',
  ...
  'Campaign Refund' => 'Campaign Refund',
  'Campaigns' => 'Campaigns',
  'Refund' => 'Refund',
  'Campaign Details' => 'Campaign Details',
  'Stopped At' => 'Stopped At',
  'Total Slots' => 'Total Slots',
  'Brand Bank Details' => 'Brand Bank Details',
  'Not Added' => 'Not Added',
  'Brand has not added bank details yet. Ask the brand to add bank details via the app before processing the refund.' => 'Brand has not added bank details yet. Ask the brand to add bank details via the app before processing the refund.',
  'Refund Calculation' => 'Refund Calculation',
  'Taxable Budget Paid' => 'Taxable Budget Paid',
  'GST Paid' => 'GST Paid',
  'Total Budget (with GST)' => 'Total Budget (with GST)',
  'Utilized Slots' => 'Utilized Slots',
  'GST on Utilized' => 'GST on Utilized',
  'Utilized (with GST)' => 'Utilized (with GST)',
  'Refundable Amount' => 'Refundable Amount',
  'Initiate Refund' => 'Initiate Refund',
  'Cannot initiate refund: brand has no bank details on file.' => 'Cannot initiate refund: brand has no bank details on file.',
  'Back to Campaign' => 'Back to Campaign',
  'Account Holder' => 'Account Holder',
  'Account Number' => 'Account Number',
  'IFSC Code' => 'IFSC Code',
  'Account Type' => 'Account Type',
  'This will create a refund entry and snapshot the brand s current bank details. You must manually transfer' => 'This will create a refund entry and snapshot the brand s current bank details. You must manually transfer',
  'to the account shown above  then mark it complete.' => 'To the account shown above  then mark it complete.',
  'Admin Note' => 'Admin Note',
  'optional' => 'Optional',
  'Internal note...' => 'Internal note...',
  'Pending' => 'Pending',
  'Refund Pending — Transfer & Mark Complete' => 'Refund Pending — Transfer & Mark Complete',
  'Transfer' => 'Transfer',
  'to:' => 'To:',
  'IFSC' => 'IFSC',
  'Confirmed Refund Amount' => 'Confirmed Refund Amount',
  'Pre-filled with calculated amount. Adjust if actual transfer differs.' => 'Pre-filled with calculated amount. Adjust if actual transfer differs.',
  'Back' => 'Back',
