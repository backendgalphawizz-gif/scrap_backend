                        ...
                        <div class="px-3 py-4">
                            <div class="row align-items-center">
                                <div class="col-lg-4 mb-3 mb-lg-0">
                                    <h5 class="mb-0 text-capitalize d-flex gap-1 align-items-center">{{ \App\CPU\translate('subscription_table')}}
                                        <span class="badge badge-soft-dark fz-12">{{$subscriptions->count()}}</span>
                                    </h5>
                                </div>
                                    ...
                                    <form action="{{ url()->current() }}" method="GET">
                                        ...
                                        <div class="input-group input-group-merge input-group-custom">
                                            ...
                                            <input id="datatableSearch_" type="search" name="search"
                                                   class="form-control"
                                                   placeholder="{{\App\CPU\translate('Search by orders id or subscription id')}}"
                        ...
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                <tr>
                                    ...
                                    <th>{{\App\CPU\translate('expiry_date')}}</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($subscriptions as $key=>$transaction)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
