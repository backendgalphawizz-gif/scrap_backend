...
@section('content')
    <div class="content container-fluid">
        <!-- Page Title -->
        <div class="mb-3">
            <h2 class="h1 mb-0 d-flex gap-10 align-items-baseline backbtndiv">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            class="category-list table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100">
...
<script>
    ...
    <script>
        ...
        var orderTable = $(".category-list").DataTable({
            // dom: 'rl<"right"Bf>tipv',
            "dom": '<"top m-2"Bf>rt<"bottom"ilp>',
            buttons: [
                {
                    extend: 'colvis',
                    className: 'btn btn--primary btn-block columnbtn',
                    text: "Columns",
            ...
            order: [[3, "asc"]],
            ajax: {
                url:"{{ route('admin.category.paginate') }}",
                data: function(data) {
