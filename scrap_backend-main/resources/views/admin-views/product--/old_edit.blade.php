                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="d-none {{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <div class="form-group pt-4">
                                        <label class="title-color">{{\App\CPU\translate('specification')}}
                                            ({{strtoupper($lang)}})</label>
                                        <textarea name="specification[]" class="textarea editor-textarea"
                                                    >{!! $translate[$lang]['specification']??$product['specification'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="row d-none">
                                <div class="col-lg-2">
                                    <label for="">{{\App\CPU\translate('Free Delivery')}}</label>
                                    <input type="checkbox" name="free_delivery" value="1" {{ $product->free_delivery == 1 ? 'checked' : '' }}>
                                </div>
                                <div class="col-lg-3">
                                    <label for="">{{\App\CPU\translate('Returnable / Cancellable')}}</label>
                                    <input type="checkbox" name="returnable" value="1" {{ $product->returnable == 1 ? 'checked' : '' }}>
                                </div>
                                <div class="col-lg-2">
                                    <label for="">{{\App\CPU\translate('Warranty Policy')}}</label>
                                    <input type="checkbox" name="is_warranty_policy" value="1" {{ $product->is_warranty_policy == 1 ? 'checked' : '' }}>
                                </div>
                                <div class="col-lg-2">
                                    <label for="">{{\App\CPU\translate('Top Brand')}}</label>
                                    <input type="checkbox" name="top_brand" value="1" {{ $product->top_brand == 1 ? 'checked' : '' }}>
                                </div>
                                <div class="col-lg-2">
                                    <label for="">{{\App\CPU\translate('Alpha Verified')}}</label>
                                    <input type="checkbox" name="is_verified" value="1" {{ $product->is_verified == 1 ? 'checked' : '' }}>
                                </div>
                                <div class="col-lg-3">
                                    <label for="">{{\App\CPU\translate('Made In')}}</label>
                                    <input type="text" name="made_in" value="{{ $product->made_in }}" placeholder="Ex: India" class="form-control">
                                </div>
                                <div class="col-lg-3">
                                    <label for="">{{\App\CPU\translate('Warranty')}}</label>
                                    <input type="text" name="warranty" value="{{ $product->warranty }}" placeholder="Ex: 1 Year" class="form-control">
                                </div>
                                <div class="col-lg-3">
                                    <label for="">{{\App\CPU\translate('Manufacturing Date')}}</label>
                                    <input type="date" name="manufacturing_date" value="{{ $product->manufacturing_date }}" placeholder="Ex: 1 Year" class="form-control">
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label for="name" class="title-color">{{ \App\CPU\translate('Seller') }}</label>
                                    <select name="user_id" class="js-example-responsive" required>
                                        <option value="">{{ \App\CPU\translate('Select') }}</option>
                                        @if(isset($sellers))
                                            @foreach($sellers as $seller)
                                                <option value="{{ $seller->id }}" {{ $seller->id == $product->user_id ? "selected" : "" }}>{{ ucwords($seller->f_name) }} ({{ucwords($seller->shop->name)}} {{$seller->phone}})</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            @foreach(\App\CPU\Helpers::units() as $x)
                                                <option
                                                    value={{$x}} {{ $product->unit==$x ? 'selected' : ''}}>{{ucfirst($x)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3 physical_product_show">
                                    ...
                                    <input type="number" min="0" step="0.01"
                                        ...
                                        value="{{ $product->net_weight ?? '' }}" class="form-control">
                                </div>
                                <div class="col-md-4 mb-3 physical_product_show">
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="title-color">{{\App\CPU\translate('selling price')}}</label>
                                    <input type="number" min="0" step="0.01"
                                            placeholder="{{\App\CPU\translate('selling price') }}"
                                            name="selling_price" class="form-control"
                                            value={{\App\CPU\Convert::default($product->selling_price)}} required>
                                </div>
                                ...
                                <!-- <div class="col-md-2 form-group d-none">
                                    ...
                                    <select name="tax_model" type="hidden" class="form-control" required>
                                        <option value="include" selected{{ $product->tax_model == 'include' ? 'selected':'' }}>{{ \App\CPU\translate("include") }}</option>
                                ...
                                <div class="d-none col-md-3 form-group physical_product_show" id="shipping_cost">
