        ...
        <div>
            ...
            <div class="d-flex flex-wrap gap-2 align-items-center mb-3 justify-content-between">
                <h2 class="h1 mb-0">
                    ...
                    @endif
                        {{ \App\CPU\translate(' Login Report') }}
                </h2>



                 <!-- <div class="driverBtn">
                    <button type="button" class="btn btn--primary btn-block" onclick="window.location.href= '{{ route('admin.login-report.user.login','user') }}'">
                        {{ \App\CPU\translate('add driver') }}
                    </button>
                 </div> -->
            </div>
            <!-- End Page Title -->
                        ...
                        <form action="{{ url()->current() }}" id="form-data" method="GET">
                            <div class="row gy-3 gx-2">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <select name="filter" class="js-example-responsive">
                                ...
                                <div class="col-lg-1 col-sm-3 col-md-3 mt-2 mt-sm-0  ">
                                    <button type="button" class="btn btn--primary btn-block" onclick="window.location.href= '{{ route('admin.login-report.user.report','user') }}'">
                        ...
                        <table class="user-report-list-table table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100" style="text-align: {{ Session::get('direction') === "rtl" ? 'right' : 'left' }}">
                            <thead class="thead-light thead-50 text-capitalize">
                                <tr>
                                    ...
                                    <th>{{ \App\CPU\translate('Login Date & Time') }}</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
...
@push('script_2')
    <script>
        ...
        var orderTable = $(".user-report-list-table").DataTable({
            ...
            order: [[0, "desc"]],
            ajax: {
                url:"{{ route('admin.login-report.user.paginate') }}/" + type,
                data: function(data) {
