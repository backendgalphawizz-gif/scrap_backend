                    ...
                    <div class="col-md-2">
                        <a href="{{route('admin.reviews.create')}}">
                            <button type="button" class="btn btn--primary" >
                                ...
                                {{\App\CPU\translate('add_new_review')}}
                            </button>
                        </a>
                    </div>
                </div>
                        ...
                        @foreach ($reviews as $key => $review)
                            @if ($review->product)
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        @if ($review->customer_id == -1)
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-xl mr-3"
                                                    src="{{ asset('storage/app/public/profile/' . ($review->user_image ?? 'default.png')) }}"
                                                    onerror="this.src='{{ asset('public/assets/back-end/img/160x160/img1.jpg') }}'"
                                                    alt="Fake User Image">

                                                <div class="media-body">
                                                    <h6 class="mb-0">{{ $review->user_name ?? 'Fake User' }}</h6>
                                                </div>
                                            </div>
                                        ...
                                        @elseif ($review->customer)
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-xl mr-3"
                                                    src="{{ asset('storage/app/public/profile/' . ($review->customer->image ?? 'default.png')) }}"
                                                    onerror="this.src='{{ asset('public/assets/back-end/img/160x160/img1.jpg') }}'"
                                                    alt="Customer Image">
                                        ...
                                        @else
                                            <label class="badge badge-soft-danger">
                                                {{ \App\CPU\translate('customer_removed') }}
                                            </label>
                                        @endif
                                    ...
                                    <td>
                                        @if($review->fake_review == 1)
                                            <a href="{{ route('admin.reviews.edit', $review->id) }}" class="btn btn-sm btn-outline-primary">
