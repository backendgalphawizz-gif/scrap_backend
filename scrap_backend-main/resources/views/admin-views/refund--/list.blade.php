...
<div class="content container-fluid">
    ...
    <div class="card">
        ...
        <div class="table-responsive mb-4">
            <table class="d-none table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100"
            ...
            <table class="refund-request-table table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100"
                    style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}}">
                <thead class="thead-light thead-50 text-capitalize">
                    <tr>
                        <th>{{\App\CPU\translate('SL')}}</th>
        ...
        @if(count($refund_list)==0)
            <div class="text-center p-4 d-none">
...
@push('script_2')
    ...
    <script>
        ...
        $('.refund-request-table').DataTable({
            ...
            order: [[0, "desc"]],
            ajax: {
                url:"{{ route('admin.refund-section.refund.list-paginate') }}" + '/' + status,
                data: function(data) {
            ...
            ,
            columns: [
                {'name': 'refund_requests.id', visible: false },
                {'name': 'order_id', visible: false },
                {'name': 'refund_requests.id' },
                {'name': 'users.f_name', 'orderable': false },
                {'name': 'refund_requests.amount' },
                {'name': 'refund_requests.status' },
                {'name': 'refund_requests.id', 'orderable': false }
            ]
        })
    </script>
@endpush
