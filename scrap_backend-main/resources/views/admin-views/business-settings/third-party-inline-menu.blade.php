<div class="inline-page-menu my-4">
    <ul class="list-unstyled">
        ...
        <li class="d-none {{ Request::is('admin/social-media-chat/view') ?'active':'' }}"><a href="{{route('admin.social-media-chat.view')}}">{{\App\CPU\translate('Social_Media_Chat')}}</a></li>

        <li class="{{ Request::is('admin/social-login/app-home') ?'active':'' }}"><a href="{{route('admin.social-login.app-home')}}">{{\App\CPU\translate('App Home')}}</a></li>
