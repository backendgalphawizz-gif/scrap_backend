...
@section('title', \App\CPU\translate('Brand Terms & Condition'))
...
@section('content')
    <div class="content-wrapper">
            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">
                        <span></span>Brand Terms & Conditions <i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="row">
            ...
            <div class="col-lg-12">
                <form action="{{route('admin.business-settings.brand-update-terms')}}" method="post">
                    @csrf
                    <div class="card-body">
